        ...
        <MainLayout title="Access Technologies Solution (ACS)">
            ...
            <div className="mil-banner-sm mil-deep-bg">
                ...
                <div className="mil-banner-content">
                    <div className="container mil-relative">
                        <Link href={route('portfolio')} className="mil-link link-left mil-mb-30">
                ...
                <div className="container">
                    ...
                    <div className="row flex-sm-row-reverse justify-content-between">
                        ...
                        <div className="col-lg-7 col-xl-8">
                            ...
                            <p className="mil-mb-60">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&apos;t look even slightly believable.</p>
                ...
                <div className="container">
                    <div className="row justify-content-between align-items-center">
                        <div className="col-xl-5 mil-mb-60">
                            ...
                            <p className="mil-mb-30">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&apos;t look even slightly believable.</p>

                            <div className="mil-icon-box-head mil-long mil-mb-15">
                                <div className="mil-icon-frame mil-icon-frame-sm">
                                    <img src="/img/icons/sm/3.svg" alt="icon" />
                                </div>
                                <p className="mil-dark">It is a long established fact that a reader will be</p>
                            </div>
                            <div className="mil-icon-box-head mil-long mil-mb-15">
                                <div className="mil-icon-frame mil-icon-frame-sm">
                                    <img src="/img/icons/sm/2.svg" alt="icon" />
                                </div>
                                <p className="mil-dark">There are many variations of passages</p>
                            </div>
                            <div className="mil-icon-box-head mil-long mil-mb-15">
                                <div className="mil-icon-frame mil-icon-frame-sm">
                            ...
                            <div className="mil-icon-box-head mil-long mil-mb-15">
                                ...
                                <p className="mil-dark">Asearch for &apos;lorem ipsum&apos; will uncover many</p>
                            </div>
            ...
            <div className="container mil-mb-120">
                <div className="mil-pagination mil-hidden-button">
                    <Link href={route('project')} className="mil-slider-nav">
                        <div className="mil-slider-btn-prev mil-button-sm mil-blog-prev"><i className="fas fa-arrow-left"></i><span className="mil-h6">Prev</span></div>
                    </Link>
                    <Link href={route('portfolio')} className="mil-button-all"><span><i className="fas fa-list"></i></span></Link>
                    <div className="mil-slider-nav">
                        <Link href={route('project')} className="mil-slider-btn-next mil-blog-next"><span className="mil-h6">Next</span><i className="fas fa-arrow-right"></i></Link>
                    </div>
                </div>
            </div>
            {/* pagination end */}
