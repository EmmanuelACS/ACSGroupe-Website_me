                ...
                <div className="mil-banner-content">
                    <div className="container mil-relative">
                        <ul className="mil-breadcrumbs mil-mb-30">
                            <li><Link href={route('home2')}>Accueil</Link></li>
                            <li><Link href={route('careers')}>Pages</Link></li>
                            <li><Link href={route('careers')}>Blog</Link></li>
                        </ul>
                ...
                <div className="container">
                    <div className="row justify-content-between">
                        ...
                        <div className="col-lg-4 col-xl-3 mil-mb-120">
                            ...
                            <Link href={route('contact')} className="mil-link"><span>Send</span><i className="fas fa-arrow-right"></i></Link>
